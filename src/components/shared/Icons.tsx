...
export const IconDrill = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 2v2m12 12h-2M4 16H2M18 2v2M6 2v2m7 18l-2-2 5-5 2 2-5 5zM5 8l-2 2 5 5 2-2-5-5z"></path></svg>
);
...
export const IconSiren = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 18v-6a5 5 0 1 1 10 0v6"></path><path d="M5 21h14"></path><path d="M21 13h1"></path><path d="M1 13h1"></path><path d="M12 1v1"></path></svg>
);
...
export const IconBarChart3 = IconBarChart;
